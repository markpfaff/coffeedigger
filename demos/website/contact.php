...
<div class="logo col-md-4">
        ...
        <a href="index.html"><img class="icon" alt="logo" src="img/logo.png" title="link back to main page"></a>
</div>
...
<?php
$mysql_host = "mysql.coffeedigger.com";
$mysql_database = "coffeediggerdb"; 
$mysql_user = "coffeedigger";
$mysql_password = "kanga#roo";
