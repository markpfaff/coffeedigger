                    ...
                    if (empty($_GET['term']) === false){
                        $search_results = search_posts($_GET['term']);
                            ...
                            foreach($search_results as $row) {
                              extract($row); # name, digs

                                # check whether we need to display a new heading
                                if($name != $last_name) {
                                  # display heading
                                  echo "<h4>REGION: ",htmlspecialchars($name),"</h4>\n\n";
                                  $last_name = $name;
                                }
                                echo "<p>",htmlspecialchars($digs),"</p>\n\n";
                            }

                            # clean up variables
                            unset($row, $name, $digs, $last_name);
