...
<!--BEGINS CONTENT-LEFT-->
    <section id="content">
            <img src="images/perugia-blend.jpg" class="content" alt="profile-image-coffee1" >
            ...
            <div class="profile-overview">
                    <div class="profile-review">
                        ...
                        <div class="dig-container">
                            ...
                            <form id="form_members" role="form" action="send_perugia.php" method="POST">
                ...
                <div class="profile-p">
                    ...
                    <p><h1 class="profile-h1">Price:</h1> $18.99</p>
