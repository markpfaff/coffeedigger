...
<!--BEGINS CONTENT-LEFT-->
    <section id="content">
            <img src="images/pike-place.jpg" class="content" alt="profile-image-coffee1" >
            ...
            <div class="profile-overview">
              ...
              <div class="profile-overview">
                ...
                <div id="icon-coffee-left">
                	<img src="images/logos/coffee-tree-logo.png" class="coffee-logo" alt="profile-image-coffee1" >
                </div>
            ...
            <div class="profile-overview">
                    <div class="profile-review">
                        ...
                        <div class="dig-container">
                            ...
                            <form id="form_members" role="form" action="send_pike.php" method="POST">
                ...
                <div class="profile-p">
                    ...
                    <p><h1 class="profile-h1">Region:</h1> Brazil </p>
                    <p><h1 class="profile-h1">Price:</h1> $9.00</p>
                    <p><h1 class="profile-h1">Trending:</h1> Ground Coffee </p>
                	</div>
                </div>
                <!--COFFEE ENDS-->
             ...
             <div class="profile-overview">
                ...
                <hr class="profile">
                <div class="profile-p">
                    <p>Skinny black id breve turkish to go cream. Kopi-luwak latte, viennese strong crema turkish filter percolator. Organic sweet instant brewed cup skinny extra bar strong body.</p>
                    <p>Body, half and half, that, steamed, coffee, medium wings eu cream single shot doppio. Irish caramelization, kopi-luwak ristretto latte turkish breve rich. Redeye half and half blue mountain that whipped milk sweet single origin.</p>
                </div>
              </div>
              <!--DESCRIPTION ENDS-->
