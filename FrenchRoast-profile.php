...
<!--BEGINS CONTENT-LEFT-->
    <section id="content">
            <img src="images/french-roast.jpg" class="content" alt="profile-image-coffee1" >
            ...
            <div class="profile-overview">
                    <div class="profile-review">
                        ...
                        <div class="dig-container">
                            ...
                            <form id="form_members" role="form" action="send_french.php" method="POST">
                ...
                <div class="profile-p">
                    ...
                    <p><h1 class="profile-h1">Price:</h1> $17.00</p>
