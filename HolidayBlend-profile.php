...
<!--BEGINS CONTENT-LEFT-->
    <section id="content">
            <img src="images/holiday-blend.jpg" class="content" alt="profile-image-coffee1" >
            ...
            <div class="profile-overview">
                    <div class="profile-review">
                        ...
                        <div class="dig-container">
                            ...
                            <form id="form_members" role="form" action="send_holiday.php" method="POST">
                ...
                <hr class="profile">
                <div class="profile-p">
                    <p><h1 class="profile-h1">Roaster:</h1> Victrola Coffee </p>
                    <p><h1 class="profile-h1">Type:</h1> Blend </p>
                    <p><h1 class="profile-h1">Roast:</h1> Medium </p>
                    <p><h1 class="profile-h1">Region:</h1> Africa </p>
                    <p><h1 class="profile-h1">Price:</h1> $15.99</p>
                    <p><h1 class="profile-h1">Trending:</h1> Holiday Blend </p>
                	</div>
                </div>
                <!--COFFEE ENDS-->
             ...
             <div class="profile-overview">
                ...
                <hr class="profile">
                <div class="profile-p">
                    <p>Rich, sweet, espresso brewed lungo ristretto grinder. Redeye eu cream irish acerbic rich shop robust whipped aroma. Skinny a, crema acerbic skinny single shot wings. Sit so at that plunger pot mocha iced frappuccino. Spoon siphon frappuccino turkish to go, caramelization cup dripper ristretto pumpkin spice.</p>
