...
<!--BEGINS CONTENT-LEFT-->
    <section id="content">
            <img src="images/brazil-carmo-de-minas.jpg" class="content" alt="profile-image-coffee1" >
    ...
    <section id="middle">
            ...
            <div class="profile-overview">
                    <div class="profile-review">
                        ...
                        <form id="form_members" role="form" action="send_formdata_coffees.php" method="POST">
                        	   <button class="dig" type="submit" name="digs" value="Submit" >
                                   <img class="button-dig" src="images/shovel.png" alt="Submit">Dig <span class="dig-score">
                                        <?php
                ...
                <div class="profile-p">
                    ...
                    <p><h1 class="profile-h1">Type:</h1> Decaf </p>
                    <p><h1 class="profile-h1">Roast:</h1> Medium </p>
                    <p><h1 class="profile-h1">Region:</h1> Brazil </p>
                    <p><h1 class="profile-h1">Price:</h1> $27.00</p>
                    <p><h1 class="profile-h1">Trending:</h1> Latte </p>
                	</div>
                </div>
                <!--COFFEE ENDS-->
