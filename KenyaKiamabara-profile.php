...
<!--BEGINS CONTENT-LEFT-->
    <section id="content">
            <img src="images/kenya-kiamabara.jpg" class="content" alt="profile-image-coffee1" >
            ...
            <div class="profile-overview">
                    <div class="profile-review">
                        ...
                        <div class="dig-container">
                            ...
                            <form id="form_members" role="form" action="send_kenyaki.php" method="POST">
             ...
             <div class="profile-overview">
                ...
                <hr class="profile">
                <div class="profile-p">
                    <p>Eu cup, doppio that black eu aftertaste aroma. Cultivar, sugar cappuccino shop wings fair trade mocha. Iced robust in skinny single shot brewed, as aftertaste froth filter grounds spoon.</p>
                    <p>Doppio, frappuccino breve shop breve caramelization galão. Crema café au lait, cream instant as qui aromatic dripper. Grinder eu, bar dripper trifecta strong beans.</p>
                </div>
              </div>
              <!--DESCRIPTION ENDS-->
